	...
	function __construct($config = array())
{
	...
	var $apiKey						= 'AIzaSyCdQNrSgwlMYbgSNjBPy2ZhU2d5tmeaKXc'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
